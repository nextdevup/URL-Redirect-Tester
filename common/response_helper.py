...
from common.settings_helper import get_http_method, get_request_headers, should_use_session
...
def make_request(url):
    if should_use_session():
        ...
        return requests.request(get_http_method(), url, headers=get_request_headers(), allow_redirects=False, verify=False)